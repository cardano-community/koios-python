...
@Exception_Handler
def get_credential_txs(self, *payment_credentials, after_block=0, content_range="0-999"):
    """
    ...
    if self.BEARER is None:
        custom_headers = {"Range": str(content_range)}
        get_format = {"_payment_credentials": [payment_credentials], "_after_block_height": str(after_block)}
